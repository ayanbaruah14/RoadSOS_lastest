...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-6 py-16 md:py-24 overflow-y-auto">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                          <div className="space-y-2.5">
                            ...
                            <div className="relative">
                              <select value={form.bloodGroup} onChange={(e) => update("bloodGroup", e.target.value)} className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-5 py-3.5 pr-10 text-sm text-white/90 outline-none transition-all duration-300 hover:bg-white/[0.05] hover:border-white/20 focus:border-cyan-500/40 appearance-none cursor-pointer">
                          ...
                          <div className="space-y-2.5">
                            ...
                            <div className="relative">
                              <select value={form.gender} onChange={(e) => update("gender", e.target.value)} className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-5 py-3.5 pr-10 text-sm text-white/90 outline-none transition-all duration-300 hover:bg-white/[0.05] hover:border-white/20 focus:border-cyan-500/40 appearance-none cursor-pointer">
                                <option value="" className="bg-[#0a0e1a]">Select</option>
                      ...
                      <div className="space-y-5 pt-2">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                          <div className="space-y-2.5">
                            ...
                            <div className="relative">
                              <select value={form.vehicleType} onChange={(e) => update("vehicleType", e.target.value)} className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl px-5 py-3.5 pr-10 text-sm text-white/90 outline-none transition-all duration-300 hover:bg-white/[0.05] hover:border-white/20 focus:border-cyan-500/40 appearance-none cursor-pointer">
                                <option value="" className="bg-[#0a0e1a]">Select</option>
